...
const DesignTeams = [
    ...
    { icon: icon2, 
      text: "Diseña y planifica la publicación de tus posts de redes sociales desde Canva" 
    },
    { icon: icon3, 
      text: "Trabaja en equipo y en tiempo real con personas de distintos países, departamentos o empresas." 
    },
    { icon: icon4, 
